...
There is now a <a href="/user_manual/1_introduction.html">user manual for revtools</a> - check there to get an overview of how the package works.

Updates in this version are as follows:
...
<b>API changes:</b>
- all function names are now lower case: <code>make_DTM</code> is now <code>make_dtm</code>; <code>run_LDA</code> is now <code>run_topic_model</code>. Note old function names have been retained where possible, but may be deleted from later versions.
